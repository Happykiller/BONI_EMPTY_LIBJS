...
(function(exports){
    ...
    BonitaLib.prototype = {
        ...
        */
        ...
        /**
         * @name bonitaLib.removeDiacritics
         * @param {Object} p
         * @param p.str
         * @returns {$.Oda.Tooling}
         */
        removeDiacritics: function(p){
            try {
                ...
                return p.str.replace(/[^\u0000-\u007E]/g, function(a){ 
                    return diacriticsMap[a] || a; 
                });
            } catch (er) {
                console.log("removeDiacritics : " + er.message);
                return null;
            }
        }
    };
